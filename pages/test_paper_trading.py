...
core_modules = [
    ...
    ("Paper Trading Engine", "pages.live_paper_trading", "PaperTradingEngine"),
...
pages_to_test = [
    "pages.enhanced_paper_trading_dashboard",
    "pages.live_paper_trading", 
    "pages.portfolio_manager",
    "pages.test_paper_trading",
    "pages.ai_optimizer",
...
with col1:
    if st.button("🔄 Refresh All Tests", type="primary", key="system_refresh_button"):
        st.rerun()

with col2:
    if st.button("📊 Open Live Trading", type="secondary", key="system_live_trading_button"):
        st.info("Navigate to Live Paper Trading page manually")

with col3:
    if st.button("⚙️ View Elite Options", type="secondary", key="system_elite_options_button"):
...
if st.checkbox("🔄 Auto-refresh every 5 minutes", key="system_auto_refresh_checkbox"):
    import time
